...
class EditarViewModel @Inject constructor(private val productoRepo: ProductsLocalDataSource, private val tiendasRepo: StoresLocalDataSource) : ViewModel() {
    ...
    var list_producto:List<ProductRoom> = listOf()
...
//VENTANA DETALLES++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    private val _producto_detalles = MutableLiveData<ProductRoom>()
    val producto_detalles: LiveData<ProductRoom> = _producto_detalles
...
//VENTANA BORRAR++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    private val _producto_borrar = MutableLiveData<ProductRoom>()
    val producto_borrar: LiveData<ProductRoom> = _producto_borrar
    ...
    fun borrarProducto(producto: ProductRoom) {
    ...
    fun updateProducto() {
      val prpducto:ProductRoom=ProductRoom(id_producto_Editando,_nombreProductoEditar.value!!, _precioCompra.value!!.toLong(), _PrecioTienda1.value!!.toLong(),  _PrecioTienda2.value!!.toLong(),   _PrecioTienda3.value!!.toLong(),  _PrecioTienda4.value!!.toLong(),   _PrecioTienda5.value!!.toLong())
