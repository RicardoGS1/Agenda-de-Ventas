...
fun VentanaDetalles(viewModel: EditarViewModel) {
    ...
    val producto_detalles: Producto by viewModel.producto_detalles.observeAsState(
        initial = Producto(
            0,
            "",
            0,
...
fun VentanaEliminar(viewModel: EditarViewModel) {
    ...
    val producto_borrar: Producto by viewModel.producto_borrar.observeAsState(
        initial = Producto(
            0,
            "",
            0,
...
@Composable
fun VistaVentanaDetalles(viewModel: EditarViewModel, activaTienda1: Boolean, activaTienda2: Boolean, activaTienda3: Boolean, activaTienda4: Boolean, activaTienda5: Boolean, producto_detalles: Producto, nombreTienda1: String, nombreTienda2: String, nombreTienda3: String, nombreTienda4: String, nombreTienda5: String) {
...
@Composable
fun VistaVentanaBorrar(viewModel: EditarViewModel, producto_borrar: Producto) {
