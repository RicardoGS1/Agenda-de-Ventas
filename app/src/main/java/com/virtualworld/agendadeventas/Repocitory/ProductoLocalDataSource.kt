...
class ProductoLocalDataSource @Inject constructor(private val productoDao: ProductoDao) {
    ...
    fun addProducto(nombre: String, compra: String, venta1: String, venta2: String, venta3: String, venta4: String, venta5: String ):Int {
        ...
        if (nombre != "" && compra != "") {
            ...
            executorService.execute {
                ...
                Log.d("Agregando producto", Producto(id, nombre, compraLong, venta1Long, venta2Long, venta3Long, venta4Long, venta5Long).toString())
    ...
    fun getAllLogs(callback: (List<Producto>) -> Unit) {
        executorService.execute {
    ...
    fun removeProducto(producto: Producto, callback: (Int) -> Unit) {
        executorService.execute {
